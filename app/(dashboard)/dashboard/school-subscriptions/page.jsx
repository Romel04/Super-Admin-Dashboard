...
const mockData = [
  ...
  {
    id: 4,
    schoolName: "Westview Junior College",
    planName: "Premium",
    price: 1299,
  ...
  {
    id: 7,
    schoolName: "Lakeside International School",
    planName: "Premium",
    price: 1299,
  ...
  {
    id: 9,
    schoolName: "Pinewood Montessori",
    planName: "Basic",
    price: 499,
...
export default function SchoolSubscriptionsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">School Subscriptions</h1>
        <p className="text-muted-foreground mt-2">
          Manage all school subscription plans and their details.
        </p>
      </div>
